...
public class PortfolioDetailPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${openTransaction.stock.name}"));
        columnBinding.setColumnName("Open Transaction.stock.name");
        ...
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${openTransaction.transactionDate}"));
        columnBinding.setColumnName("Open Transaction.transaction Date");
        columnBinding.setColumnClass(java.util.Date.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${openTransaction.price}"));
        columnBinding.setColumnName("Open Transaction.price");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${closeTransaction.transactionDate}"));
        columnBinding.setColumnName("Close Transaction.transaction Date");
        columnBinding.setColumnClass(java.util.Date.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${openTransaction.stock.name}"));
        columnBinding.setColumnName("Open Transaction.stock.name");
        columnBinding.setColumnClass(String.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${quantity}"));
        ...
        columnBinding.setColumnClass(Double.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${closeTransaction.price}"));
        columnBinding.setColumnName("Close Transaction.price");
        columnBinding.setColumnClass(Double.class);
        columnBinding.setEditable(false);
